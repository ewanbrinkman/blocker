...
export default class PreloaderScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.registry.levels.normal.forEach((filename) => {
            this.load.tilemapTiledJSON(filename, 'assets/maps/levels/normal/' + filename + '.json');
        });
        // Load challenges made with Tiled in JSON format.
        this.registry.levels.hard.forEach((filename) => {
            this.load.tilemapTiledJSON(filename, 'assets/maps/levels/hard/' + filename + '.json');
        });
